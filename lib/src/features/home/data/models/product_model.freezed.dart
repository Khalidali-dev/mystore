...
class _ProductModel implements ProductModel {
  const _ProductModel({final  List<Product> products = const []}): _products = products;
...
as Dimension?,warrantyInformation: null == warrantyInformation ? _self.warrantyInformation : warrantyInformation // ignore: cast_nullable_to_non_nullable
...
class _Product implements Product {
  const _Product({this.id = 0, this.title = '', this.description = '', this.category = '', this.price = 0.0, this.discountPercentage = 0.0, this.rating = 0.0, this.stock = 0, final  List<String> tags = const [], this.brand = '', this.sku = '', this.weight = 0.0, this.dimensions, this.warrantyInformation = '', this.shippingInformation = '', this.availabilityStatus = '', final  List<Review> reviews = const [], this.returnPolicy = '', this.minimumOrderQuantity = 1, this.meta, final  List<String> images = const [], this.thumbnail = ''}): _tags = tags,_reviews = reviews,_images = images;
...
@override final  Dimension? dimensions;
...
@override $DimensionCopyWith<$Res>? get dimensions;@override $MetaCopyWith<$Res>? get meta;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DimensionCopyWith<Dimension> get copyWith => _$DimensionCopyWithImpl<Dimension>(this as Dimension, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Dimension&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.depth, depth) || other.depth == depth));
}
...
abstract mixin class $DimensionCopyWith<$Res>  {
  factory $DimensionCopyWith(Dimension value, $Res Function(Dimension) _then) = _$DimensionCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$DimensionCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Dimension value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Dimension value)  $default,){
final _that = this;
switch (_that) {
case _Dimension():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Dimension value)?  $default,){
final _that = this;
switch (_that) {
case _Dimension() when $default != null:
return $default(_that);case _:
...
class _Dimension implements Dimension {
  const _Dimension({this.width = 0.0, this.height = 0.0, this.depth = 0.0});
  factory _Dimension.fromJson(Map<String, dynamic> json) => _$DimensionFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$DimensionCopyWith<_Dimension> get copyWith => __$DimensionCopyWithImpl<_Dimension>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$DimensionToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Dimension&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.depth, depth) || other.depth == depth));
}
...
/// @nodoc
abstract mixin class _$DimensionCopyWith<$Res> implements $DimensionCopyWith<$Res> {
  factory _$DimensionCopyWith(_Dimension value, $Res Function(_Dimension) _then) = __$DimensionCopyWithImpl;
@override @useResult
$Res call({
 double width, double height, double depth
});
...
/// @nodoc
class __$DimensionCopyWithImpl<$Res>
